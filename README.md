...
This is a AngularJS application and is preconfigured to install the Angular
...
to your repository and execute scripts such as building the app or running tests. This application
